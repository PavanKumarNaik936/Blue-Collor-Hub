const indiaStatesWithDistricts = {
  "Andhra Pradesh": [
  ...
  "Chhattisgarh": [
    ...
    "Gariaband", "Janjgir-Champa", "Jashpur", "Kanker", "Kondagaon",
    "Korba", "Korea", "Mahasamund", "Mungeli", "Narayanpur",
  ...
  "Gujarat": [
    ...
    "Mehsana", "Morbi", "Narmada", "Navsari", "Patan", "Porbandar",
  ...
  "Karnataka": [
    ...
    "Ballari", "Bidar", "Chamarajanagar", "Chikkaballapur",
  ...
  "Odisha": [
    ...
    "Malkangiri", "Mayurbhanj", "Nabarangpur", "Nuapada", "Puri",
  ...
  "Tamil Nadu": [
    ...
    "Theni", "Thoothukudi", "Tiruchirappalli",
  ...
  "Uttar Pradesh": [
    ...
    "Chandauli", "Chitrakoot", "Deoria", "Etah", "Etawah", "Ayodhya",
...
export default indiaStatesWithDistricts;
